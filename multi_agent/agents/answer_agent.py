...
_SYSTEM_PROMPT = (
    ...
    # "7. If Composio tool execution context is provided, incorporate the external tool "
    # "results (GitHub, Google Docs, YouTube, Context7, Hugging Face, Tavily) into your answer."
)
...
_CRITIC_PROMPT = (
    ...
    f"2. TEMPORAL CONSISTENCY: Current date is {datetime.now().strftime('%A, %B %d, %Y')}. Verify that relative temporal statements "
